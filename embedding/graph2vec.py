...
def load_embeddings(dir_name):
    ...
    """
    with open(f'{EMBEDDING_DIR}/{dir_name}/g2v_embeddings.pkl', 'rb') as f:
        embeddings = pickle.load(f)

    with open(f'{EMBEDDING_DIR}/{dir_name}/g2v_true_labels.pkl', 'rb') as f:
...
def create_g2v_embeddings(graph_list, true_labels, dir_name):
    ...
    parent_dir = Path(EMBEDDING_DIR).joinpath(dir_name)
